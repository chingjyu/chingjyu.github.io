...
![下载页截图](https://chingjyu.cyou/assets/image/download-page.png)
...
![软件主界面](https://chingjyu.cyou/assets/image/main-interface.png)

点击“安装 Office”进入“部署”页。确保“部署模式”是“下载”。

![部署页](https://chingjyu.cyou/assets/image/deployment-page.png)

点击“添加产品”，在窗口选择你需要的 Office 版本，然后点击“确定”。建议使用 `Office LTSC 专业增强版 2024 - 批量许可证`，搜索框输入 `2024Volume` 即可找到。

![版本选择](https://chingjyu.cyou/assets/image/edition-selection.png)

点击“添加产品”，在窗口的搜索框输入 zh-cn 选择 `简体中文（中国）`，然后点击“确定”。

![语言选择](https://chingjyu.cyou/assets/image/language-selection.png)
...
![部署页-安装](https://chingjyu.cyou/assets/image/deployment-page-installation.png)

出现这样的界面，点击“是”，安装就开始了。

![安装确认](https://chingjyu.cyou/assets/image/installation-confirmation.png)
...
![激活页](https://chingjyu.cyou/assets/image/activation-page.png)
...
![激活页-1](https://chingjyu.cyou/assets/image/activation-page-1.png)

划到下面的“许可证列表”，点右侧的“展开”和“刷新”，应该会出现一个以 Office 24 开头的许可证。然后展开，点击下面的“激活”。

![激活页-2](https://chingjyu.cyou/assets/image/activation-page-2.png)

恭喜你，如果出现这个界面，那就是激活成功了，enjoy!

![激活成功](https://chingjyu.cyou/assets/image/successful-activation.png)
